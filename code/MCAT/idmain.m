...
%    xlswrite(['wid_XI',num2str(i),'.xls'],XI);
%    xlswrite(['wid_xd',num2str(i),'.xls'],xd);
%    xlswrite(['wid_yd',num2str(i),'.xls'],yd);
%    xlswrite(['wid_dat',num2str(i),'.xls'],dat(:,i));
%    xlswrite(['wid_tmx',num2str(i),'.xls'],tmx(:,grouping));
%    xlswrite(['wid_tmy',num2str(i),'.xls'],tmy);
